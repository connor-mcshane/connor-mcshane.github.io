---
title: "Yet Another Streamlit App (For Return Stacking)"
...
I'm a fan of Pensioncraft and was interested in Ramin's [return stacking video](https://www.youtube.com/watch?v=DCyOEaeM9wk). The short version: return stacking uses leverage to give you more than 100% market exposure — e.g. instead of spending 1 dollar to buy a 60/40 ETF you can spend 67 cents for the same exposure, with the money saved you then layer on uncorrelated assets over the top. No free lunch, obviously, but it seemed like it could work alongside a regular equities portfolio as a shorter-term,  lower volatility option. I wanted to pull the data myself and see what the numbers actually look like in Streamlit.
...
Same tickers, same weights, same date range. Should've been close. Here's what CAGR (compound annual growth rate — basically the annualised return) looked like in my app versus Portfolio Visualizer:
...
A five percentage point gap is well past rounding error — enough to flip the conclusion on whether the strategy actually works.
